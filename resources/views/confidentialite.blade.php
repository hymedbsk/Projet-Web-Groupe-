...
<div class="container">
  ...
  <ul>
    ...
    <li>Publication d'annonce sur la plateforme</li>
  </ul>
  ...
  <ul>
    ...
    <li>Courriel : <a href="mailto:ephec-entreprendre@ephec.be">ephec-entreprendre@ephec.be</a></li>
    <li>Section du site web : <a href="entreprendre.che2-ephec.be/contact" target="_blank">entreprendre.che2-ephec.be/contact</a></li>
  </ul>
  <hr>
  ...
  <p>Nous nous engageons à respecter les dispositions législatives énoncées dans :
    <br><a href="https://www.ephec.be/mentions-legales" target="_blank">https://www.ephec.be/mentions-legales</a>
  </p>
</div>
